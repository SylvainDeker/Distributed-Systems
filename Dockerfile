...
&& pip3 install "dask[complete]" numpy rasterio fiona Shapely bokeh opencv-python pytest pytest-datafiles pyprof2calltree graphviz cachey cffi pyyaml git+git://github.com/jcrist/pycallgrind \
&& apt-get clean
WORKDIR /root/
